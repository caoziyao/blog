...
import notebook_pb2 as notebook__pb2
...
class NotebookStub(object):
  ...
  def __init__(self, channel):
    ...
    self.GetNotebookInfo = channel.unary_unary(
        ...
        request_serializer=notebook__pb2.NotebookRequest.SerializeToString,
        response_deserializer=notebook__pb2.NotebookResponse.FromString,
        )
...
def add_NotebookServicer_to_server(servicer, server):
  rpc_method_handlers = {
      'GetNotebookInfo': grpc.unary_unary_rpc_method_handler(
          ...
          request_deserializer=notebook__pb2.NotebookRequest.FromString,
          response_serializer=notebook__pb2.NotebookResponse.SerializeToString,
      ),
  }
